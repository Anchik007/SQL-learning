...
SELECT p.PaymentID, p.PaymentAmount, o.Quantity, pr.Price
FROM Payments p
...
SELECT mgr.EmployeeName AS Manager, emp.EmployeeName AS Subordinate, 
       mgr.Salary AS ManagerSalary, emp.Salary AS SubordinateSalary
FROM Employees emp
