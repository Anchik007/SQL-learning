...
Select distinct Category, ProductName from Products order by ProductNmae Desc;
...
SELECT * FROM Orders WHERE OrderDate BETWEEN DATEADD(DAY, -180, CURRENT_DATE) AND CURRENT_DATE;
